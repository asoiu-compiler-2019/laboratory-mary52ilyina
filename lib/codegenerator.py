...
class CodeGenerator:
    ...
    def generate_header(self):
        ...
        code = [
            ...
            'long long int MM[MM_SIZE];',
            'long long int R[R_SIZE];',
            '',
    ...
    def generate_footer(self):
        ...
        code = [
            ...
            '    MM[R[FP]+2] = (long long int)((char*)&MM[R[HP]]);',
            '    R[HP] = R[HP] + R[0];',
            '    R[0] = MM[R[FP]];',
            '    goto *(void*)R[0];',
            '',
    ...
    def get_register(self, inc=True):
        """
    ...
    def generate_program_entry(self, program_name, program_num, debug):
        ...
        self.generate('MM[R[FP]] = (long long int )&&%s_%d_end;' %
    ...
    def generate_procedure_call(self, procedure_name, procedure_num, debug):
        ...
        # Push the return address onto the stack
        self.generate('MM[R[SP]] = (long long int)&&%s_%d_%d;' %
