...
"""
Token class
An object factory containing token information.
...
"""
Identifier class
An object factory containing identifier information.
...
Identifier = namedtuple(
    'Identifier', ['name', 'type', 'size', 'params', 'mm_ptr']
)


"""
Parameter class
An factory containing procedure parameter information.
...
class IdentifierTable(list):
    ...
    def find(self, name):
        ...
        if name in self[-1]:
            ...
            raise ParserNameError(f'Name "{name}" not defined in the scope.')
    ...
    def is_param(self, name):
        ...
        if owner != 'global' and owner.params:
